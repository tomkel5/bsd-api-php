...
class MessageFactory extends \GuzzleHttp\Message\MessageFactory {
    ...
    public function createRequest($method, $url, array $options = [])
    {
        ...
        $id = $request->getConfig()->get('auth')[0];
        ...
        $hash = $this->generateMac($request->getUrl(), $request->getQuery()->toArray(), $request->getConfig()->get('auth')[1]);
    ...
    protected function generateMac($url, $query, $secret)
    {
